  ...
  return (
    <Router basename="/">
      ...
      <Routes >
        ...
        firstVideo="/videos/notesSignUp_fixed_web.mp4"
        secondVideo={`/videos/notesSignUp_fixed_web.mp4?t=${Date.now()}`}
        thirdVideo={`/videos/notesSignUp_fixed_web.mp4?t=${Date.now()}`}
        note={true}
